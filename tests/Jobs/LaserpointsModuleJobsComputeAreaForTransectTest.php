...
class LaserpointsModuleJobsComputeAreaForTransectTest extends TestCase {
    ...
    public function testHandleHeuristic()
    {
        ...
        with(new ComputeAreaForTransect($image->transect, 20))->handle();
    ...
    public function testHandleManual()
    {
        ...
        with(new ComputeAreaForTransect($image->transect, 30))->handle();
